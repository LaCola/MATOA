...
***************************************************************************** */
        ...
        function addToCart() {
            ...
            document.querySelector(".prise-product__old") && document.querySelector(".prise-product__old").innerHTML;
            document.querySelector(".prise-product__current").innerHTML;
            ...
            setTimeout((() => {
                imageFlyBlock.style.cssText = `\n   \t\ttop: calc( ${headerCart.getBoundingClientRect().top}px + 5%);\n   \t\tleft: ${headerCart.getBoundingClientRect().left}px;\n   \t\twidth: 0;\n   \t\theight: 0;\n   \t\topacity: 0;\n   \t\ttransition: all ${speed}ms;\n   \t`;
            }), 5);
            setTimeout((() => {
        ...
        document.querySelector(".footer").addEventListener("click", spoilerClickHandler);
        function spoilerClickHandler(evt) {
            const spoilerSwitchElem = evt.target.closest(".footer__title");
            if (spoilerSwitchElem) spoilerSwitchElem.closest(".footer__title").classList.toggle("active");
        }
        window["FLS"] = true;
        isWebp();
        addTouchClass();
